...
def prepare(rowfile, picfile, jfile, savename, size, small, span):
    ...
    for i in os.listdir(rowfile):
        ...
        # x = l//2-shape[0]//2
        # y = l//2-shape[1]//2
        # simg[x:x+shape[0],y:y+shape[1],:] = img[:,:,:]
        ...
        os.remove(os.path.join(rowfile,i))
...
prepare(
    rowfile = r"killqueen\picture",
    picfile = r"killqueen\trainpic",
    jfile = r"killqueen\d_num.json",
    savename = r"killqueen\train.pickle",
    size = 200,
    small = 32,
    span = 2000
)
prepare(rowfile= r"killqueen\test_picture",
    picfile= r"killqueen\testpic",
    jfile= r"killqueen\t_num.json",
    savename= r"killqueen\test.pickle",
    size= 200,
    small= 32,
    span= 100)